if game:GetService("Players").LocalPlayer.UserId == 123456 or game:GetService("Players").LocalPlayer.UserId == 3934009832 or game:GetService("Players").LocalPlayer.UserId == 3903046899 or game:GetService("Players").LocalPlayer.UserId == 3896454787 or game:GetService("Players").LocalPlayer.UserId == 905447099 or game:GetService("Players").LocalPlayer.UserId == 1895856208 or game:GetService("Players").LocalPlayer.UserId == 3946274321 or game:GetService("Players").LocalPlayer.UserId == 2334731416 or game:GetService("Players").LocalPlayer.UserId ==  3881683072 or game:GetService("Players").LocalPlayer.UserId == 112953127 or game:GetService("Players").LocalPlayer.UserId == 1608533943 or game:GetService("Players").LocalPlayer.UserId == 3247270390 or game:GetService("Players").LocalPlayer.UserId == 3537909010 or game:GetService("Players").LocalPlayer.UserId == 3675789472 or game:GetService("Players").LocalPlayer.UserId == 3343906766 or game:GetService("Players").LocalPlayer.UserId == 1132495855 or game:GetService("Players").LocalPlayer.UserId == 3253403109 or game:GetService("Players").LocalPlayer.UserId == 3566325842 then
...
UIS.InputBegan:Connect(function(inp)
    if inp.KeyCode == Enum.KeyCode.Space and game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("AimbotGui").AimbotFrame.RangeText.Text == "In Range" then
        ...
        while wait() do
            ...
            if _G.aim == false then return end
            elseif playerAndHoopDistance3 <= 47 and playerAndHoopDistance3 >= 39 then
                camera.CFrame = CFrame.new(camera.CFrame.Position, getClosest().Position + Vector3.new(0, 65, 0))
            if _G.aim == false then return end
            elseif playerAndHoopDistance3 <= 47.35 and playerAndHoopDistance3 >= 47 then
                camera.CFrame = CFrame.new(camera.CFrame.Position, getClosest().Position + Vector3.new(0, 76.5, 0))
            if _G.aim == false then return end
            elseif playerAndHoopDistance3 <= 49.1 and playerAndHoopDistance3 >= 47.35 then
            ...
            elseif playerAndHoopDistance3 <= 63.25 and playerAndHoopDistance3 >= 62 then
                ...
                if _G.aim == false then return end
            elseif playerAndHoopDistance3 <= 63.6 and playerAndHoopDistance3 >= 63.25 then
