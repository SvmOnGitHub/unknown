...
spawn(function()
    while wait() do
        ...
        if playerAndHoopDistance2 <= 74 and playerAndHoopDistance2 > 63.6 then
            power.Value = 85
        elseif playerAndHoopDistance2 <= 63.6 and playerAndHoopDistance2 > 47.4 then
            power.Value = 80
        elseif playerAndHoopDistance2 <= 47.4 then
            power.Value = 75
